/*
  JavaScript code to interact with the agent created on api.ai.
...
$(document).ready(function() {
  ...
  // get the text inserted by the user and submit to api.ai
...
/* Functions for handling the response coming from api.ai*/
